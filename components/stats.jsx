    ...
    <div>
      ...
      <div className="stats-container">
        ...
        <div className="stats-section">
          ...
          <div className="bar-text-wrapper">
            ...
            <div className="bar-description">
              <p>올해는 전반적으로 기쁜 날이 많았지만,<br/>피곤한 날들도 조금 많았어요.</p>
            </div>
          </div>
        </div>
        ...
        <div className="stats-section">
          ...
          <div className="bar-text-wrapper">
            <div className="bar-chart">
              <div className="bar month1" style={{ height: '70%' }}>1월</div>
              <div className="bar month2" style={{ height: '65%' }}>2월</div>
              <div className="bar month3" style={{ height: '80%' }}>3월</div>
              <div className="bar month4" style={{ height: '55%' }}>4월</div>
